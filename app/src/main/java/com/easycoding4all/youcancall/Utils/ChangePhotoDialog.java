package com.easycoding4all.youcancall.Utils;
...
import com.easycoding4all.youcancall.R;
...
public class ChangePhotoDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view= LayoutInflater.from(getContext()).inflate(R.layout.dialog_changephoto,container,false);
